...
const translations = {
    en: {
        ...
        saved_port_setups: "Saved Setups",
        save_as_setup: "Save Current as Setup",
        port_setups_instructions: "Save the Active/Secondary/Playback ports above as a named setup. Give each setup a priority number - the bottom button on the device cycles through setups in ascending priority order.",
        priority: "Priority",
        auto_connect_label: "Auto-connect ports",
        no_port_setups: "No saved setups yet.",
        apply: "Apply",
        edit: "Edit",
        delete: "Delete",
        save: "Save",
        ...
        timezone_change_confirm: "Changing timezone to {0} will restart the visualizer. This may take a moment. Continue?",
        timezone_change_success: "Timezone changed. Visualizer is restarting. Page will refresh shortly.",
        timezone_change_error: "Failed to change timezone: {0}",
